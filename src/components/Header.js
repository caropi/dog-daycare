      ...
      <div className="nav">
        <nav className="wrapper nav__container">
          ...
          <div className="nav__list-container">
            <ul className="nav__list-container--list desktopOnly">
              <li className="nav__list-container--list-item">
                <a href="https://www.himama.com/">Who Uses WoofMama</a>
              </li>
              <li className="nav__list-container--list-item">
                <a href="https://www.himama.com/">Features</a>
              </li>
              <li className="nav__list-container--list-item">
                <a href="https://www.himama.com/">Resources</a>
              </li>
            </ul>
          ...
          <ul className="mobileOnly nav__list-container--list">
            <li className="nav__list-container--list-item">
              <a href="https://www.himama.com/">Who Uses WoofMama</a>
            </li>
            <li className="nav__list-container--list-item">
